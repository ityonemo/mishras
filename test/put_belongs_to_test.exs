defmodule Mishras.PutBelongsToTest do
  ...
  defmodule BelongsToSchema do
    ...
    def changeset(struct \\ %__MODULE__{}, attrs) do
      ...
      |> required_assoc_or_id(:parent, attrs)
    end

    defp required_assoc_or_id(changeset, assoc, attrs) do
      assoc_id = :parent_id
  ...
  describe "put belongs to schema build" do
  ...
  describe "put belongs to schema insert" do
    test "is provided with sane defaults" do
